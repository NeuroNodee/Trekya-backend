# Generated by Django 5.2.8 on 2026-02-27 14:25
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('friends', '0003_alter_friendship_unique_together_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['sender', 'receiver', 'status'], name='fr_sender_receiver_status_idx')],
